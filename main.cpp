	...
	while (Novice::ProcessMessage() == 0)
	{
		...
		case GAMEPLAY: //ゲームプレイ
			...
			if (isPAlive)
			{
				...
				if (attackFlag)
				{
					if (standbyFlagL == 1 && attackTimer < 15)
					{
					...
					if (standbyFlagL == 1 && attackTimer < 30)
					{
					...
					if (standbyFlagL == 1 && attackTimer < 45)
					{
					...
					if (standbyFlagL == 1 && attackTimer < 60)
					{
					...
					if (standbyFlagR == 1 && attackTimer < 15)
					{
					...
					if (standbyFlagR == 1 && attackTimer < 30)
					{
					...
					if (standbyFlagR == 1 && attackTimer < 45)
					{
					...
					if (standbyFlagR == 1 && attackTimer < 60)
					{
				...
				if (runFlag == false)
				{
					...
					else  if (walkFlagL == 1 && walkTimerL < 20) {
					...
					else  if (walkFlagL == 1 && walkTimerL < 30) {
					...
					else  if (walkFlagL == 1 && walkTimerL < 40) {
					...
					else  if (walkFlagR == 1 && walkTimerR < 20) {
					...
					else  if (walkFlagR == 1 && walkTimerR < 30) {
					...
					else  if (walkFlagR == 1 && walkTimerR < 40) {
